...
categories:
  - dariah
abstract: XPath (XML Path Language) is a standard query language for selecting
  nodes from XML documents. In this step-by-step tutorial, you will learn how to
  write XPath expressions in order to navigate around our XML-encoded
...
![](https://i.imgur.com/bxlpn5F.png)

#### Types of nodes in XML

You should already be familiar with the basics of XML notation: ![img](https://i.imgur.com/kOweUG8.png) and different types of nodes in XML:
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        Selects all nodes with the name "<i>nodename</i>"
      </td>
    </tr>
...
![](https://i.imgur.com/IcebWeT.png)

| Expression    | Selects                                  |     |
| ------------- | ---------------------------------------- | --- |
| `//form/orth` | all orth nodes that are children of form |     |

![](https://i.imgur.com/hM6tbUC.png)
