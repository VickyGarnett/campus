...
categories:
  - dariah
abstract: This tutorial explains the fundamentals and usage of the DARIAH-DE
  Collection Registry, a tool that allows you to describe and index data
  collections. The manual gives an overview of the usability and functionalities
  of the Collection Registry and introduces best practice recommendations.
...
![Image of front page of DARIAH-DE Collection Registry](/assets/images/cms/resources/dariah-de-collection-registry-tutorial/colreg1.jpg)
...
<ExternalResource title="Interested in learning more?" subtitle="Click here to go to the DARIAH-DE Collection Registry Manual" url="https://dfa.de.dariah.eu/doc/colreg/#" />