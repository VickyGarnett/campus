...
<VideoCard
  title="Click to view"
  id="DUlfC8NL0Bs"
  image="/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_and_skos_title_image.JPG"
/>
...
**Diagram 1.** below shows how controlled vocabularies are embedded in architecture of an information system (the example is derived from DEFC controlled vocabulary [^2]). In this example, the Archeological site is a Universal abstract class, whereas Athens is an instance of Archaeological site class and a Particular that represents the exact and real archaeological site studied and described in the system. Athens can be of one or many types that are defined in a controlled vocabulary, for example, it can be a type of ‘Hillside’.

![Diagram 1. Controlled vocabularies in data architecture](/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_and_skos_model_diagram_1.png)
...
Tim Berners-Lee in his fundamental paper “The Semantic Web” (2001) says that on the Semantic Web “information is given well-defined meaning” [^3]. CVs are one of the tools used for this mission.
...
![Diagram 2. Usage of a common controlled vocabulary for data description in different projects](/assets/images/cms/resources/controlled-vocabularies-and-skos/diagram_2.jpg)

Another approach on **Diagram 3.** shows how different projects use their own project-specific controlled vocabularies. The vocabularies are linked to each other through established relationships among concepts in both of them. Therefore we can refer to data in Project 1 using matching concepts from the controlled vocabulary of Project 2. The linking happens on a level of a concept description when the statement is encoded that the concept is exact/related/close match (etc.) to a concept from another CV or from a large semantic network, e.g. Dbpedia [^6].

![Diagram 3. Interoperable controlled vocabularies](/assets/images/cms/resources/controlled-vocabularies-and-skos/diagram_3.jpg)

There are also meta-vocabularies developed with a primary goal to be a high-level overarching vocabulary for more domain-specific CVs. Therefore making it easier to connect local CVs and establish relationships among them through common meta-level concepts. Backbone Thesaurus [^7] is one of the examples in the DH domain that has as its purpose to allow interdisciplinary CVs development and integration.

![BBT - Backbone Thesaurus in Vocabs repository](/assets/images/cms/resources/controlled-vocabularies-and-skos/bbt.png)

## SKOS Standard

### About SKOS

SKOS is a Simple Knowledge Organization System, a common data model for sharing and linking knowledge organization systems via the Web [^8].
...
Informative guide SKOS Primer [^9] [https://www.w3.org/TR/skos-primer/](https://www.w3.org/TR/skos-primer/) .

Normative guide SKOS Reference [^10] intended for users who have a good understanding of Semantic Web technology, especially RDF and OWL SKOS Reference [https://www.w3.org/TR/skos-reference/](https://www.w3.org/TR/skos-reference/) .
...
Sometimes it is required to describe relationships among lexical labels representing concepts. For this SKOS provides an extension SKOS-XL [^11] - SKOS eXtension for Labels - to identify, describe and link lexical labels.
...
**Question 1. Select all triples with <u>correct</u> RDF syntax.** _Please, assume the following prefixes for all options:_
...
**1.** `ex:europeanWildcat a skos Concept; skos prefLabel “European wildcat”@en.`

**2.** `ex:europeanWildcat rdf:type skos:Concept; skos:preflabel “European wildcat”@en.`

**3.** `ex:europeanWildcat a skos:Concept; skos:prefLabel “European wildcat”@en.`

**4.** `ex:europeanWildcat rdf:type skos:Concept, skos:preflabel “European wildcat”@en.`

**Question 2. Select all <u>correct</u> SKOS records.** _Please, assume the following prefixes for all options:_
...
**1.** `ex:eurasianLynx a skos:Concept; skos:prefLabel “Eurasian lynx”@en; skos:prefLabel “Lynx”@en.`

**2.** `ex:eurasianLynx a skos:Concept; skos:prefLabel “Eurasian lynx”@en; skos:prefLabel “Eurasischer Luchs”@de.`

**3.** `ex:eurasianLynx a skos:Concept; skos:prefLabel “Eurasian lynx”@en; skos:altLabel “Lynx”@en.`

**4.** `ex:eurasianLynx a skos:Concept; skos:prefLabel “Eurasian lynx”@en; skos:prefLabel “Eurasischer Luchs”@en.`

**Question 3. Select all <u>incorrect</u> SKOS records.** _Please, assume the following prefixes for all options:_
...
**1.** `ex:europeanWildcat a skos:Concept; skos:exactMatch ex:eurasianLynx.`

**2.** `ex:europeanWildcat a skos:Concept; skos:exactMatch wikidata:Q148833.`

**3.** `ex:europeanWildcat a skos:Concept; skos:broader ex:wildcat; skos:broadMatch ex:wildcat.`

**4.** `ex:europeanWildcat a skos:Concept; skos:broader ex:wildcat; skos:broadMatch wikidata:Q43576.`

**Question 4. Select all <u>incorrect</u> statements.**

**Options**

**1.** Concept can be a top Concept of Concept Scheme and have a broader Concept in this Concept Scheme.

**2.** Concept can have several preferred labels in one language.

**3.** Concept can be broader and narrower of another Concept at the same time.

**4.** Concept can have several alternative labels in one language.

**Question 5. Select all <u>correct</u> statements.**

**Options**

**1.** Concept can’t have more than one preferred label in one language.

**2.** It is recommended to create a new Concept for each synonym of a term.

**3.** Concept can have a broader matching concept in another Concept Scheme and can be linked to it.

**4.** Concept can have many matching Concepts in external Concept Schemas.
...
![Picture 2. Controlled vocabularies in IAD curation interface](/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_in_curation_interface.PNG)
...
![Picture 3. Pop up with a vocabulary term definition and traslations in user interface](/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_popup_in_userinterface.png)

- Faceted search is based on CVs: dropdowns and autocompletes

Picture 4. CV in faceted search interface

![Picture 4. Controlled vocabularies in IAD search interface](/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_in_search_interface_01.png)

Picture 5. CV in faceted search interface

![Picture 5. Controlled vocabularies in IAD search interface](/assets/images/cms/resources/controlled-vocabularies-and-skos/cv_in_search_interface_02.PNG)
...
![Picture 6. IAD - Iron-Age-Danube Thesaurus in Vocabs repository](/assets/images/cms/resources/controlled-vocabularies-and-skos/vocabs_iad.JPG)
...
1. [Vocabs repository](https://vocabs.acdh.oeaw.ac.at/en/) is a service based on the open source tool SKOSMOS [^14] to allow publication, reuse and retrieval of controlled vocabularies. It provides an API endpoint in order to integrate vocabulary terms in web applications.
...
3. [Vocabs SPARQL](https://vocabs-sparql.acdh.oeaw.ac.at/) is an interface for querying vocabularies triple store with SPARQL queries. It is developed on top of Jena Fuseki [^15] triple store and uses a YASGUI [^16] interface to access the endpoint.
...
**Question 2.** Answer: 2 and 3

**Question 3.** Answer: 1 and 3

**Question 4.** Answer: 1, 2 and 3

**Question 5.** Answer: 1, 3 and 4
...
[^2]: DEFC Thesaurus [https://vocabs.acdh.oeaw.ac.at/defc_thesaurus/en/](https://vocabs.acdh.oeaw.ac.at/defc_thesaurus/en/)
[^3]: Berners-Lee, Tim, James Hendler, and Ora Lassila. "The semantic web." Scientific american 284, no. 5 (2001): 28-37.
[^4]: [https://www.w3.org/RDF/](https://www.w3.org/RDF/)
[^5]: DariahTeach: Text encoding and the Text Encoding Initiative [https://teach.dariah.eu/course/view.php?id=23](https://teach.dariah.eu/course/view.php?id=23)
[^6]: [https://wiki.dbpedia.org/](https://wiki.dbpedia.org/)
[^7]: Backbone Thesaurus [https://www.backbonethesaurus.eu/](https://www.backbonethesaurus.eu/)
[^8]: Alistair Miles, Sean Bechhofer . SKOS Reference, W3C Recommendation 18 August 2009, [https://www.w3.org/TR/skos-reference/](https://www.w3.org/TR/skos-reference/)
[^9]: SKOS Primer [https://www.w3.org/TR/skos-primer/](https://www.w3.org/TR/skos-primer/)
[^10]: SKOS Reference [https://www.w3.org/TR/skos-reference/](https://www.w3.org/TR/skos-reference/)
[^11]: SKOS eXtension for Labels (SKOS-XL) [https://www.w3.org/TR/skos-reference/skos-xl.html](https://www.w3.org/TR/skos-reference/skos-xl.html)
[^12]: [https://www.iron-age-danube.eu/](https://www.iron-age-danube.eu/)
[^13]: IAD Thesaurus [https://vocabs.acdh.oeaw.ac.at/iad_thesaurus/en/](https://vocabs.acdh.oeaw.ac.at/iad_thesaurus/en/)
[^14]: [http://skosmos.org/](http://skosmos.org/)
[^15]: [https://jena.apache.org/documentation/fuseki2/](https://jena.apache.org/documentation/fuseki2/)
[^16]: [https://triply.cc/docs/yasgui](https://triply.cc/docs/yasgui)
